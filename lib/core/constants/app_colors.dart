...
class AppColors{
  ...
  /*static const LinearGradient metallicGradient = LinearGradient(
    colors: [
      Color(0xFF2C2C2C), // çok koyu metal gri
      Color(0xFF383838), // hafif geçiş
      Color(0xFF1E1E1E), // daha da koyu, gölge efekti gibi
      Color(0xFF2A2A2A), // yumuşak geçişli parlama hissi
    ],
